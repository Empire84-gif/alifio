...
from services.email_notifications import send_email_message
...
from services.email_notifications import assign_client_verification_token, send_email_message
...
def send_booking_status_changed_emails(notification_ctx, new_status):
    ...
    if normalized_status == "cancelled":
        ...
        client_html = render_template(
            ...
            extra_note="W celu wybrania innego terminu anuluj obecną rezerwację, a następnie dokonaj nowej przez formularz online dostępny na stronie."
            **common_data,
        )
