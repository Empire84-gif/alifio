...
def send_booking_status_changed_emails(notification_ctx, new_status):
    ...
    if normalized_status == "cancelled":
        ...
        client_html = render_template(
            ...
            extra_note="W razie pytań lub chęci ustalenia nowego terminu prosimy o kontakt bezpośrednio z salonem.",
            **common_data,
        )
        ...
        client_text = dedent(f"""
            ...
            W razie pytań lub chęci ustalenia nowego terminu prosimy o kontakt bezpośrednio z salonem.
...
def update_settings():
    ...
    try:
        ensure_column(cursor, "business_settings", "website_url", "TEXT")
...
def admin_calendar():
    ...
    for i in range(7):
        ...
        if is_working_day:
            ...
            if day_reason == "employee_time_off":
                ...
                day_status_label = "wolne"
                day_status_icon = "bi-calendar-x"

            elif day_reason == "missing_hours":
                day_status_label = "brak godzin"
                day_status_icon = "bi-exclamation-circle"

            elif day_reason == "exception_missing_hours":
                day_status_label = "brak godzin"
                day_status_icon = "bi-exclamation-circle"
        ...
        week_days.append({
            ...
            "is_today": day_date == datetime.today().date(),
    ...
    for booking in bookings:
        ...
        duration = booking["duration_minutes"] or slot_interval
...
@app.route("/admin/calendar/weather")
def admin_calendar_weather():
    latitude = os.getenv("WEATHER_LATITUDE", "48.7606")
    longitude = os.getenv("WEATHER_LONGITUDE", "8.2398")
    ...
    try:
        ...
        temperature = round(float(current.get("temperature_2m")))
