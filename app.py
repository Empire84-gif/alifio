        ...
        if time_off_action == "save_schedule":
            ...
            if cropped_employee_photo_data:
                try:
                    ...
                    object_key = f"employees/{new_filename}"
                ...
                try:
                    ...
                    new_photo_path = upload_fileobj_to_b2(
                        fileobj=photo_file,
                        object_key=object_key,
                        content_type=photo_file.mimetype or None
                    )
                    ...
                    print("Błąd uploadu zdjęcia pracownika do B2:", e)
                    flash("Nie udało się zapisać zdjęcia pracownika.", "error")
                    return redirect(url_for("admin_settings"))
