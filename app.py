...
def ai_chat():
    ...
    def is_allowed_date_input(value):
        ...
        return bool(date_pattern.match(value)) or value in quick_words
        ...
        if current_stage == "time":
            if current_service and current_employee and current_context.get("date_iso"):
                try:
                    ...
                    print("Błąd pomocy etapu time AI:", e)
    ...
    if not selected_employee:
        ...
        if found_employee:
            ...
            return json_response(reply=reply, context=context)
    ...
    if not context.get("date_iso"):
        ...
        if date_iso:
            ...
            try:
                ...
                print("Błąd sprawdzania slotów AI po wyborze daty:", e)
